...
const Login = resolve => require.ensure([], () => resolve(require("view/index/Login")), "Login");
const Register = resolve => require.ensure([], () => resolve(require("view/index/Register")), "Register");
const Bookdetail = resolve => require.ensure([], () => resolve(require("view/index/Bookdetail")), "Bookdetail");
const Booklist = resolve => require.ensure([], () => resolve(require("view/index/Booklist")), "Booklist");
const Bookcase = resolve => require.ensure([], () => resolve(require("view/index/Bookcase")), "Bookcase");
const Reading = resolve => require.ensure([], () => resolve(require("view/index/Reading")), "Reading");
